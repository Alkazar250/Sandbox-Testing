...
namespace TestProject1
{
    ...
    public class GetAllAuthorsCoded : WebTest
    {

        public GetAllAuthorsCoded()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            if ((this.Context.ValidationLevel >= Microsoft.VisualStudio.TestTools.WebTesting.ValidationLevel.High))
            {
                ...
                validationRule1.RequiredTagName = "Author";
            ...
            request1.Headers.Add(new WebTestRequestHeader("SOAPAction", "http://tempuri.org/GetAllAuthors"));
...
<soap:Envelope xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"" xmlns:soap=""http://schemas.xmlsoap.org/soap/envelope/"">
  <soap:Body>
    <GetAllAuthors xmlns=""http://tempuri.org/"" />
  </soap:Body>
</soap:Envelope>";
